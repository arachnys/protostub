...
var simpleMypy = "fromtypingimportcast,Dict,List,TupleclassFoo:bar:strbaz:intdef__init__(self,bar:str=None,baz:int=None)->Foo:...defCopyFrom(self,other:Foo)->None:...defSerializeToString(self)->bytes:...defParseFromString(self,data:bytes)->None:...@staticmethoddefListFields()->Tuple[FieldDescriptor,value]:..."
...
var enumMypy = "fromtypingimportcast,Dict,List,TupleclassFoo:BAR:AnyBAZ:AnyQUUX:Anydef__init__(self,BAR:Any=None,BAZ:Any=None,QUUX:Any=None)->Foo:...defName(enumClass:Foo)->Any:...defValue(memberName:str)->Any:...defCopyFrom(self,other:Foo)->None:...defSerializeToString(self)->bytes:...defParseFromString(self,data:bytes)->None:...@staticmethoddefListFields()->Tuple[FieldDescriptor,value]:..."
